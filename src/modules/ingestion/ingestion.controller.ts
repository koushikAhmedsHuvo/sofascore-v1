...
export class IngestionController {
  ...
  @ApiOperation({
    ...
    description: 'Runs `teamBundlePaths(teamId)` — roster, stats, fixtures, etc.',
  })
  @ApiParam({ name: 'teamId', type: 'number', description: 'SofaScore team id' })
  @ApiOkResponse({ type: MessageResponseDto })
  ...
  @ApiOperation({
    ...
    description: 'Runs the full tournament metadata job for every active tournament id.',
  })
  @ApiOkResponse({ type: MessageResponseDto })
  ...
  getCoverage(): ApiCoverageResponseDto {
    ...
    return {
      ...
      coverage: {
        note:
          'Paths verified against: sofascore.com (Antigravity), developer_finding.txt, matchstat_nextjs, football-nest-api proxy, sofascore-wrapper.',
        'sport-level': [
